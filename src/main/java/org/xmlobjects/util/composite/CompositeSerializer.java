...
public abstract class CompositeSerializer<T> implements ObjectSerializer<T> {
    private final Class<? extends ObjectSerializer<T>> serializer;

    @SuppressWarnings("unchecked")
    public <S extends ObjectBuilder<? super T> & ObjectSerializer<? super T>> CompositeSerializer(Class<S> adapter) {
