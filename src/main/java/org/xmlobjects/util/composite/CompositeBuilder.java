...
public abstract class CompositeBuilder<T> implements ObjectBuilder<T> {
    private final Class<? extends ObjectBuilder<T>> builder;

    @SuppressWarnings("unchecked")
    public <S extends ObjectBuilder<? super T> & ObjectSerializer<? super T>> CompositeBuilder(Class<S> adapter) {
